...
import {MinecraftOnDemandWebsiteStack} from '../lib/web-stack';
...
// Might as well put the website in London too
new MinecraftOnDemandWebsiteStack(app, 'MinecraftOnDemandWebsiteStack', {env: {region: 'eu-west-2'}});